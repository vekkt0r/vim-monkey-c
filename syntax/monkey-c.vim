...
syn keyword	monkeyCKeyword		using as extends has instanceof self me import typedef and or
...
syn keyword	monkeyCType		Graphics System Lang WatchUi Timer Attention Drawable Storage Symbol ResourceId
syn keyword	monkeyCType    		Number Float Char Long Double String Void Boolean Array Dictionary
